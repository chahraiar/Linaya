-- Migration: Add is_visible support to update_person function
-- Description: Allow updating person visibility through update_person RPC

-- Update the update_person function to include is_visible parameter
...
-- Create a dedicated function for toggling visibility (simpler API)
CREATE OR REPLACE FUNCTION public.set_person_visibility(
  p_person_id uuid,
...
-- Fix search_path for security
ALTER FUNCTION public.set_person_visibility(uuid, boolean)
SET search_path = family_tree, public;
